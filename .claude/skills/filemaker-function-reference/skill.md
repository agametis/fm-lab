...
1. **DuckDB reference index** — `docs/claris-help/fm_reference.duckdb`
   ...
   *Generated by the REST-API build and copied into the docs directory via the skill [`install-claris-docs`](../install-claris-docs/SKILL.md). Standalone copy for this skill — independent of the REST-API server.*
