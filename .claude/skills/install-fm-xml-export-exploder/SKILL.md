...
```bash
bash .claude/skills/install-fm-xml-export-exploder/scripts/install_fm_xml_export_exploder.sh
```

Or with force flag:
```bash
bash .claude/skills/install-fm-xml-export-exploder/scripts/install_fm_xml_export_exploder.sh --force
```
