...
large exports, plus per-catalog SAX overrides under `sql/convert-xml/streamify/`
— generated by `tools/gen_streamify_sql.sh`, so changes to the heavy catalogs in
