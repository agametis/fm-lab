 ...
 *
 * This script creates a type-safe API client using openapi-fetch
 * based on the generated TypeScript types from openapi.yaml
 */
...
const outputPath = join(__dirname, '../generated/client.ts');
