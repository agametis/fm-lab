-- Auto-generiert aus dem core der Rule (exit_script_in_loop). Nicht von Hand editieren.
SELECT
...
SELECT 'exit-script-in-loop' AS rule_id, 'warning' AS severity,
    ...
    'Exit Script inside loop (depth ' || loop_depth_before || ') at step ' || Step_Index AS message,
