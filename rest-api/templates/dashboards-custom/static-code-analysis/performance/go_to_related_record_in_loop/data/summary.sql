-- Auto-generiert aus dem core der Rule (go_to_related_record_in_loop). Nicht von Hand editieren.
SELECT
...
SELECT
    ...
    'Go to Related Record inside Loop (loop depth ' || loop_depth_before || ') at step ' || (Step_Index + 1) AS message,
