-- Auto-generiert aus dem core der Rule (insert_from_url_in_loop). Nicht von Hand editieren.
SELECT
...
SELECT
    ...
    'Insert from URL inside Loop (loop depth ' || loop_depth_before || ') at step ' || (Step_Index + 1) AS message,
