-- Auto-generiert aus dem core der Rule (sort_records_in_loop). Nicht von Hand editieren.
SELECT
...
SELECT
    ...
    'Sort Records inside Loop (loop depth ' || loop_depth_before || ') at step ' || (Step_Index + 1) AS message,
